...
const myExtenstion = require("../../extension");
...
suite("Extension Test Suite", () => {
    ...
    test("getReplaceString should return the correct replace string", () => {
        ...
        assert.strictEqual(myExtenstion.getReplaceString(classNamesMap, className), "className={`${styles.header.header} ${styles.header.top}`}");
    });
